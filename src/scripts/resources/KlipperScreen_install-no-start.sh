#!/bin/bash
# Script taken from jordan's repo: https://github.com/jordanruthe/KlipperScreen/blob/master/scripts/KlipperScreen-install.sh
# Removed the init. of the service
